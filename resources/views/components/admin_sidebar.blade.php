 <!-- ======= Sidebar ======= -->
 <aside id="sidebar" class="sidebar " style="background-color:#800080 !important; ">
  ...
  <ul class="sidebar-nav" id="sidebar-nav">
    ...
    <li class="nav-heading text-white">Pengetahuan</li>
    ...
    <li class="nav-heading text-white" >Pengaturan</li>
      ...
      <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
        <li>
          <a href="/dashboard/add_admin">
            <i class="bi bi-circle"></i><span  class="text-white">Tambah Admin</span>
          </a>
        </li>
        <li>
          <a href="/dashboard/admin">
            <i class="bi bi-circle"></i><span class="text-white">Daftar Admin</span>
          </a>
        </li>
      </ul>
    </li><!-- End Forms Nav -->

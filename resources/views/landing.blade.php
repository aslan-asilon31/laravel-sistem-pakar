 ...
 ================================================== -->
    ...
    <main>
        ...
        <div class="section full-height mob-height">
            <div class="background-parallax" style="background-image: url('landing/img/full-0.jpg')"
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 page-center-text-wrap text-center">
                        <h1 class="parallax">
                            <img src="{{asset('landing/img/logo-dark.png')}}" alt="" srcset="">
                        </h1>
                    </div>
                </div>
            </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 text-center">
                        <div id="owl-sep-1" class="owl-carousel owl-theme">
                            <div class="item">
                                <div class="quote">
                                    <p class="lead">"DepresiCheck adalah situs yang membantu orang-orang mengukur
        ...
        <div class="section padding-top-big" hidden>
            <div class="container">
                <div class="row justify-content-center">
                ...
                <div class="accordion" id="faqAccordion">
                    <div class="card">
                        ...
                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                            ...
                            <div class="card-body">
                                DepresiCheck adalah sebuah situs yang membantu orang-orangakhir mengukur tingkat depresi
                                mereka dengan mengisi formulir pertanyaan. Kami menyediakan solusi sesuai setelah
                                orang-orangmengisi formulir tersebut.
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        ...
                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
                            data-parent="#faqAccordion">
                            <div class="card-body">
                                DepresiCheck ditujukan untuk orang-orangakhir, namun siapa saja dapat mengakses situs ini
                    ...
                    <div class="card">
                        ...
                        <div id="collapseFour" class="collapse" aria-labelledby="headingFour"
                            data-parent="#faqAccordion">
                            <div class="card-body">
                                Setelah mengisi formulir, orang-orangakan menerima rekomendasi solusi sesuai dengan
                                tingkat depresi yang terdeteksi. Kami juga menyediakan tautan ke sumber informasi dan
                                bantuan profesional yang dapat membantu orang-orangmengatasi depresi mereka.
                            </div>
                        </div>
                    </div>
                </div>
